load 'FrenchRetail1.csv';
y = FrenchRetail1(:,2); Q = FrenchRetail1(:,1); x=FrenchRetail1(:,3);
T = length(y); t = (1:T)'; a=ones(341,1);
...
for t = T0:T-h
    ...
    xt = x(1:t);
    Xt = [ones(t,1) (1:t)' D4t xt];
    beta1 = (Xt'*Xt)\(Xt'*yt);
    yhat1 = [1 t+h D4(t+h) x(t+h)]*beta1;
    syhat(t-T0+1) = yhat1;
end
