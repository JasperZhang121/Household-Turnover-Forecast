tic;
load 'Household.csv';
y = Household(:,2);y = log(y);
HouseholdHoltFunction([0.7 0.3 0.5]);%MSFE for aplha = 0.7, beta = 0.3, gamma = 0.5
[parametersstar MSFEstar] = fminsearch(@HouseholdHoltFunction, [0.2 0.2 0.2])
toc

function MSFE = HouseholdHoltFunction(parameters)  
load 'Household.csv';
